...
export class EmployeePositionsController {
  ...
  create(@Body() createEmployeePositionDto: CreateEmployeePositionDto) {
    return this.employeePositionsService.create(createEmployeePositionDto).then((data) => ({ data }));
  }
  ...
  findOne(@Param('id') id: string) {
    return this.employeePositionsService.findOne(+id).then((data) => ({ data }));
  }

  @Patch(':id')
  update(@Param('id') id: string, @Body() updateEmployeePositionDto: UpdateEmployeePositionDto) {
    return this.employeePositionsService.update(+id, updateEmployeePositionDto).then((data) => ({ data }));
  }
