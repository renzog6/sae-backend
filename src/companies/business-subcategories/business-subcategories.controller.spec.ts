// filepath: sae-backend/src/companies/business-subcategories/business-subcategories.controller.spec.ts
...
describe('BusinessSubcategoriesController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [{ provide: BusinessSubcategoriesService, useValue: serviceMock }],
    }).compile();

    controller = module.get<BusinessSubcategoriesController>(BusinessSubcategoriesController);
  });
  ...
  it('create delegates to service', async () => {
    ...
    const res = await controller.create({ name: 'Sub', businessCategoryId: 10 } as any);
