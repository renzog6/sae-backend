// filepath: sae-backend/src/companies/business-categories/business-categories.controller.spec.ts
...
describe('BusinessCategoriesController', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [{ provide: BusinessCategoriesService, useValue: serviceMock }],
    }).compile();
