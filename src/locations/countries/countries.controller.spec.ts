// file: sae-backend/src/locations/countries/countries.controller.spec.ts
...
describe('CountriesController', () => {
  ...
  const mockService = {
    ...
    findProvinces: jest.fn().mockResolvedValue([{ id: 10, name: 'Buenos Aires', countryId: 1 }]),
  ...
  it('GET /locations/countries/:id/provinces -> { data: [] }', async () => {
    ...
    expect(res).toEqual({ data: [{ id: 10, name: 'Buenos Aires', countryId: 1 }] });
  });
});
